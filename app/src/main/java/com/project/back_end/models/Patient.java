...
public class Patient {
     ...
     * - The @JsonProperty annotation prevents the password from being sent in API responses.
     */
     ...
     * - The @Size(max = 255) annotation ensures that the address does not exceed 255 characters in length,
     * providing validation for the address input.
     */
