...
public class Admin {
     ...
     * - It is the primary key of the entity, identified by the @Id annotation.
     */
    @Id
     ...
     * - The field is marked with @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) to prevent the password
     * from being exposed in JSON responses.
